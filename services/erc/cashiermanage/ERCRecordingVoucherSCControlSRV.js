...
exports.ERCRecordingVoucherSCControlResource = (req, res) => {
    ...
    }else if (method==='getRecordingVoucherSCDetail'){
        getRecordingVoucherSCDetail(req,res)
    }else if (method==='getSubsidiaryLedgersInit'){
        getSubsidiaryLedgersInit(req, res)
    }else if (method==='getSubsidiaryLedgersList'){
        getSubsidiaryLedgersList(req, res)
    }else if (method==='getSubsidiaryLedgersDetail'){
        getSubsidiaryLedgersDetail(req, res)
    }else if (method==='getSubsidiaryLedgersExpense'){
        getSubsidiaryLedgersExpense(req, res)
    }else if (method==='getGeneralLedgerList'){
...
async function getRecordingVoucherSC(req,res){
    try{
        ...
        for(let r of result.data){
            ...
            } else if (resultTemp.recordingvouchersc_type == 100){
                resultTemp.order_type = '银行账号金额调整'
            } else {
...
async function getRecordingVoucherSCDetail(req,res){
